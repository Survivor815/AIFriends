...
<template>
  <div class="flex justify-center">
    <div class="avatar relative">
      ...
      <div @click="fileInputRef.click()" class="w-28 h-28 rounded-full bg-black/150 absolute left-0 top-0 flex justify-center items-center cursor-pointer">
        <CameraIcon />
      </div>
    </div>
  </div>
  ...
  <dialog ref="modal-ref" class="modal">
    <div class="modal-box transition-none">
      ...
      <div ref="croppie-ref" class="flex flex-col"></div>
